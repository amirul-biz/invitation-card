...
export const canvaImagesConfig: CanvaImageConfig[] = [
  ...
  {
    id: "1",
    url: "https://drive.google.com/uc?export=view&id=1Ul2-ajiZCTwK4q0IB0glKoTTgSGUm1LB",
    alt: "Main Image",
  },
  {
    id: "2",
    url: "https://drive.google.com/uc?export=view&id=1J7o0ZD3DiGjkyiUobpIiX1e6tfCi023M",
    alt: "Invitation image",
  },
  {
    id: "3",
    url: "https://drive.google.com/uc?export=view&id=1MpZ7ZCb1_Td8WwkP6aNk-XzZeS1Y5Qtx",
    alt: "Invitation image",
  },
];
...
export const baseBackGroundImageCountdownConfig: BaseImageCountDownConfig = {
  //TODO
  id: "bg-1",
  url: "https://drive.google.com/uc?export=view&id=1z-0aPqtKM0Fog630Bo5PIwi9JxHih4En",
...
export const backgroundVideoConfig: BackgroundVideoConfig = {
  url: "https://zqepkcfvfiordlcniblv.supabase.co/storage/v1/object/sign/Wedding%20Videos/E-card-demo-opening-video/demo-e-card-urus-danial-zafrina.mp4?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV8yZDM2NmI5My1hM2RjLTRmMzEtOGQ2Zi1mZmIzOGNhODJlYzYiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJXZWRkaW5nIFZpZGVvcy9FLWNhcmQtZGVtby1vcGVuaW5nLXZpZGVvL2RlbW8tZS1jYXJkLXVydXMtZGFuaWFsLXphZnJpbmEubXA0IiwiaWF0IjoxNzYxNjQ3NTcxLCJleHAiOjIwNzcwMDc1NzF9.iSqxdFAo8ZvqNxIrNCpES5qsqml3vWX8xmsdZQ7S3wU", //TODO
