...
export const weddingCalendarConfig: CalendarDrawerConfig = {
  ui: {
   ...
   startDate: "2025-12-25T03:30:00Z", // 11:30 AM MYT is 03:30 AM UTC
...
export const moneyGiftConfig: MoneyGiftConfig = {
  ...
  qrCodeImageUrl:
    "https://drive.google.com/uc?export=view&id=1-psoo6PAjg1rXgbJy7oUA1kqN4QHVf9K", //TODO
  translations: {
    title: "Salam Kaut",
...
export const locationConfig: LocationConfig = {
  coordinates: {
    latitude: 4.6310497, //TODO
    longitude: 101.0793304, //TODO
  },
  locationInfo: {
    title: "Lokasi Kami",
