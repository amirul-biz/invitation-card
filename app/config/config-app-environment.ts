...
export const weddingCountdownConfig: CountdownConfig = {
  event: {
    ...
    date: "2027-09-20T03:00:00Z", //TODO
...
export const weddingCalendarConfig: CalendarDrawerConfig = {
  ...
  event: {
    ...
    startDate: "2027-09-20T03:00:00Z", // 11:00 AM MYT is 03:00 AM UTC //TODO
    endDate: "2027-09-20T08:00:00Z", // 04:00 PM MYT is 08:00 AM UTC //TODO
    timeZone: "Asia/Kuala_Lumpur",
  },
};
...
export const canvaImagesConfig: CanvaImageConfig[] = [
  ...
  {
    id: "1",
    url: "https://drive.google.com/uc?export=view&id=1hKHYArq7VAfCf4jlfJ3hv33dMohH7jc4",
    alt: "Main Image",
  },
  {
    id: "2",
    url: "https://drive.google.com/uc?export=view&id=14Qysz3mk8Eh9O8t8Z8Fr1NQPTquu35-h",
    alt: "Invitation image",
  },
  {
    id: "3",
    url: "https://drive.google.com/uc?export=view&id=1uJiK3CyjI0iQpT8j7sFOkCnrBRUvJ61B",
    alt: "Invitation image",
  }
];
...
export const baseBackGroundImageCountdownConfig: BaseImageCountDownConfig = {
  //TODO
  id: "bg-1",
  url: "https://drive.google.com/uc?export=view&id=1olHpZQpME0qvNMxnTMsjRdfjbGWh1KxK",
...
export const backgroundVideoConfig: BackgroundVideoConfig = {
  url: "https://zqepkcfvfiordlcniblv.supabase.co/storage/v1/object/sign/Wedding%20Videos/E-card-demo-opening-video/demo-e-card-ahmad-firdaus-nurul-amylia.mp4?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV8yZDM2NmI5My1hM2RjLTRmMzEtOGQ2Zi1mZmIzOGNhODJlYzYiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJXZWRkaW5nIFZpZGVvcy9FLWNhcmQtZGVtby1vcGVuaW5nLXZpZGVvL2RlbW8tZS1jYXJkLWFobWFkLWZpcmRhdXMtbnVydWwtYW15bGlhLm1wNCIsImlhdCI6MTc2MTY0NzY0NiwiZXhwIjoyMDc3MDA3NjQ2fQ.jRaC5P6pDQUjcuFob8ze-95S6GMKWE4GKY0ztqsRaxo", //TODO
